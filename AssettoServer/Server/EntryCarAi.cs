...
public partial class EntryCar
{
    ...
    public byte[] LastSeenAiSpawn { get; set; }//lig edit: added set
    public byte[] AiPakSequenceIds { get; set; }//lig edit: added set
    public AiState?[] LastSeenAiState { get; set; }//lig edit: added set
    ...
    public void AiInit()//lig edit: changed private to public
    {
